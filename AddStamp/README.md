...
This kit contains the AddStamp sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./add_stamp.py <input_path> <stamp_string> <output_path> [<alpha>]
```

To get help:

```bash
python ./add_stamp.py -h
```

...
This kit contains the AddText sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./add_text.py <input_path> <text_string> <output_path>
```

To get help:

```bash
python ./add_text.py -h
```

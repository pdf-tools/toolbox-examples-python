...
This kit contains the SetInfo sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./set_info.py <input_path> <key> <value> <output_path>
```

To get help:

```bash
python ./set_info.py -h
```

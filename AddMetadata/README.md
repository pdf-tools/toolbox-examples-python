...
This kit contains the AddMetadata sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./add_metadata.py <input_path> <output_path> [<mdatafile>]
```

To get help:

```bash
python ./add_metadata.py -h
```

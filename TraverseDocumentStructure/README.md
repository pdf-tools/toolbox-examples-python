...
This kit contains the TraverseDocumentStructure sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./traverse_document_structure.py <input_path>
```

To get help:

```bash
python ./traverse_document_structure.py -h
```

...
This kit contains the SetOpenDestination sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./set_open_destination.py <input_path> <page_number> <output_path>
```

To get help:

```bash
python ./set_open_destination.py -h
```

...
This kit contains the MergeWithOutlines sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./merge_with_outlines.py <input_path> [<input_path2> ...] <output_path>
```

To get help:

```bash
python ./merge_with_outlines.py -h
```

...
This kit contains the FillFormFields sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./fill_form_fields.py <field_i_d> <value> <input_path> <output_path>
```

To get help:

```bash
python ./fill_form_fields.py -h
```

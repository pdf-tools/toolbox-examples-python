...
This kit contains the RemoveWhiteText sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./remove_white_text.py <input_path> <output_path>
```

To get help:

```bash
python ./remove_white_text.py -h
```

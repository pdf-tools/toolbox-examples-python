...
This kit contains the FileExtraction sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./file_extraction.py <input_path> <output_dir>
```

To get help:

```bash
python ./file_extraction.py -h
```

...
This kit contains the RotatePages sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./rotate_pages.py <page_number> [<page_number2> ...] <input_path> <output_path>
```

To get help:

```bash
python ./rotate_pages.py -h
```

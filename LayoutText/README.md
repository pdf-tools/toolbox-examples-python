...
This kit contains the LayoutText sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./layout_text.py <text_path> <output_path>
```

To get help:

```bash
python ./layout_text.py -h
```

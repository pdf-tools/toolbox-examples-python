...
This kit contains the UpdateAnnotations sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./update_annotations.py <input_path> <input_fdf_path> <output_path> <output_fdf_path>
```

To get help:

```bash
python ./update_annotations.py -h
```

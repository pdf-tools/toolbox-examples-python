...
This kit contains the SplitAtOutlines sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./split_at_outlines.py <input_path> <output_dir> [<level>]
```

To get help:

```bash
python ./split_at_outlines.py -h
```

...
This kit contains the AddDataMatrix sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./add_data_matrix.py <input_path> <image_path> <output_path>
```

To get help:

```bash
python ./add_data_matrix.py -h
```

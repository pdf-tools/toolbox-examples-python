...
This kit contains the MergeAndCreateTableOfContents sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./merge_and_create_table_of_contents.py <input_path> [<input_path2> ...] <output_path>
```

To get help:

```bash
python ./merge_and_create_table_of_contents.py -h
```

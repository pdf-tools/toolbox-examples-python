...
This kit contains the TextExtraction sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./text_extraction.py <input_path>
```

To get help:

```bash
python ./text_extraction.py -h
```

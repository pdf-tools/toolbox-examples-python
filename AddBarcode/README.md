...
This kit contains the AddBarcode sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./add_barcode.py <input_path> <barcode> <fontfile> <output_path>
```

To get help:

```bash
python ./add_barcode.py -h
```

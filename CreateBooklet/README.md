...
This kit contains the CreateBooklet sample for PdfTools SDK for Python. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./create_booklet.py <input_path> <output_path>
```

To get help:

```bash
python ./create_booklet.py -h
```
